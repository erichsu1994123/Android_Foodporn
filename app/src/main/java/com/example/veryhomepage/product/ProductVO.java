...
public class ProductVO implements java.io.Serializable{
    ...
    public ProductVO(String product_id, String recipe_id, String product_type, String product_name,
                     Integer product_price, Integer product_status, Double carbohydrate, Double protein,
    ...
    public boolean equals(Object obj) {
        ...
        if(obj != null && obj instanceof ProductVO){
            return this.getProduct_name().equals(((ProductVO)obj).getProduct_name());
        }else{
            return false;
        }
    }
    ...
    public String toString() {
        return "ProductVO [product_id=" + product_id + ", recipe_id=" + recipe_id + ", product_type=" + product_type
                ...
                + ", product_status=" + product_status + ", carbohydrate="
