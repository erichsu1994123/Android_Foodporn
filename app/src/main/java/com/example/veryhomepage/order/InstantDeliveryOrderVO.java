...
//    private Timestamp oc_time;
    ...
    public InstantDeliveryOrderVO(String ido_no, String member_id, String staff_id, Timestamp o_time, Integer p_method, Integer p_status, Integer total, String d_address, String qrcode, Integer o_status, Timestamp oc_time, List<OrderProductVO> orderProductVOList) {
        super();
        this.ido_no = ido_no;
