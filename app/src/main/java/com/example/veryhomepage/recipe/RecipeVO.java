...
public class RecipeVO implements java.io.Serializable{
    ...
    public RecipeVO(String recipe_id, String rcstyle_no, String member_id, String recipe_name, String recipe_type, Integer recipe_status, Integer refollow_num, Date recipe_uldate, String recipe_ingredient, String recipe_step, String recipe_photo, Integer cook_time, Double calo_intake, Double salt_intake, Double protein_intake, Double fat_intake, Double carbo_intake, Double vitamin_b, Double vitamin_c, Double vage_intake, String recipe_content) {
